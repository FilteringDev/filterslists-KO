...
import { GetUnifiedExternalSourceUrls, type UnifiedExternalSource } from './unified-external-source-urls.ts'

export { GetUnifiedExternalSourceUrls } from './unified-external-source-urls.ts'
export type { UnifiedExternalSource } from './unified-external-source-urls.ts'
